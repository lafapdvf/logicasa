            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="text-slate-300">
                ...
                <p className="leading-relaxed text-lg mb-6">
                  ...
                  realizam com a automação, inovação e com a ideia de
                  transformar casas em ambientes inteligentes, funcionais e
                  elegantes.
                </p>
                <p className="leading-relaxed border-l-2 border-[#00c2ff] pl-6 py-2 italic text-slate-400">
                  ...
                  cada residência é única. Nosso compromisso é entregar
                  automação de alto nível, com atenção aos detalhes, segurança e
                  conforto.
                </p>
              </div>
            </div>
